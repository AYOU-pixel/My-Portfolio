...
const PORTFOLIO_CONFIG = {
  ...
  resumeUrl: "/RACHIDI-AYOUB-FlowCV-Resume-20260127.pdf",
  socials: {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto">
           A Front-End Developer specializing in building responsive, production-ready web interfaces with React and Next.js
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            <p className="text-slate-300 leading-relaxed">
              Hello! I am a dedicated developer based in Salé, Morocco, with a strong focus on UI quality, performance, and maintainability. My journey in web development is driven by self-learning, transitioning from a scientific academic background to mastering modern web technologies.
            </p>
            <p className="text-slate-300 leading-relaxed">
              I have hands-on experience building real-world projects, including:


Modern Fashion E-Commerce: A front-end focused platform inspired by ZARA, featuring Stripe integration and optimized user flows.


Airbnb Clone: A booking platform where I implemented responsive UI systems, wishlists, and secure authentication.

I am passionate about clean code and problem-solving, utilizing a tech stack that includes Next.js, Tailwind CSS, TypeScript, and Prisma. Currently, I am open to remote roles, internships, and freelance projects where I can contribute immediately while growing my full-stack experience.
            </p>
          </div>
