...
const PROJECTS = [
  ...
  {
  "id": 4,
  "title": "IRONCLAD Gym Landing Page",
  "description": "A conversion-optimized, mobile-first landing page template built for fitness businesses. Designed with a WhatsApp-centric lead capture system, linear persuasion flow, and a 90-day transformation framework to maximize conversions and client acquisition.",
  "image": "/gym.png",
  "link": "https://landing-page-gym-blush.vercel.app",
  "github": "https://github.com/AYOU-pixel/LandingPageGym",
  "tech": ["HTML", "CSS", "JavaScript", "Tailwind CSS", "AOS Animations", "Font Awesome", "Google Fonts"],
  "featured": true,
  "category": "Web Development",
  "status": "Live",
  "metrics": "Built in 3 days"
}
];
