...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] md:w-[500px] md:h-[500px] bg-sky-500/10 rounded-full blur-[100px] md:blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] md:w-[400px] md:h-[400px] bg-indigo-500/10 rounded-full blur-[80px] md:blur-[100px] pointer-events-none" />
              ...
              <div className="flex items-center justify-center lg:justify-start gap-2.5 md:gap-3">
                {TECH_STACK.map((tech) => (
                  ...
                  >
                    ...
                    <div className="absolute -top-9 left-1/2 -translate-x-1/2 px-2 py-1 bg-[#1e293b] text-white text-[11px] font-medium rounded-md opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap border border-white/10 shadow-xl">
                      {tech.name}
                    </div>
                  </motion.div>
                ))}
